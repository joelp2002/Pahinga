    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <Button onClick={() => navigate('/booking')} size="lg" className="bg-blue-600 hover:bg-blue-700">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl">
          ...
          <p className="text-lg mb-8 text-blue-100">Experience paradise with world-class facilities and services</p>
          <Button onClick={() => navigate('/booking')} size="lg" className="bg-white text-blue-900 hover:bg-blue-50 text-lg px-8 py-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <CardContent>
              ...
              <p className="mt-4 text-sm text-gray-600">Pool day packages for groups also available via booking.</p>
            </CardContent>
          </Card>
          ...
          <Card className="overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <CardContent>
              <p className="text-gray-700 mb-4">
                Grand event hall packages by headcount (venue 9am–9pm). Shared pool access for your guests; pool is not
                private.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <ul className="space-y-1 font-mono text-xs">
                  {EVENT_HALL_PAX_RATES.map((t) => (
                    <li key={`${t.minPax}-${t.maxPax}`}>
                      {t.maxPax >= 999 ? `${t.minPax}+ pax` : `${t.minPax}–${t.maxPax} pax`}: ₱{t.price.toLocaleString()}
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">Reserve your preferred dates and services online with our automated system</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">Check service availability instantly and avoid double bookings</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">Unified system for all resort operations and services</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">Book anytime, anywhere with our online reservation system</p>
              </CardContent>
            </Card>
          </div>
        </div>
